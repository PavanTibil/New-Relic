...
variable "dlistener_ms_secret" {
  description = "Secret for App Runner instance"
  type        = string
  default     = "arn:aws:secretsmanager:ap-south-1:849008733010:secret:prod-apprunner-dlistner-config-D8pW0P"
}
variable "drouter_ms_secret" {
  description = "Secret for App Runner instance"
  type        = string
  default     = "arn:aws:secretsmanager:ap-south-1:849008733010:secret:prod-apprunner-drouterms-GvoSZ5"
}
